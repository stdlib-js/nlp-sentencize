...
```javascript
sentencize = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/nlp-sentencize@v0.2.3-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/nlp-sentencize@v0.2.3-umd/browser.js"></script>
```
...
[@stdlib/nlp/tokenize]: https://github.com/stdlib-js/nlp-tokenize/tree/umd
