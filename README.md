...
```javascript
import sentencize from 'https://cdn.jsdelivr.net/gh/stdlib-js/nlp-sentencize@v0.2.3-deno/mod.js';
```
...
[@stdlib/nlp/tokenize]: https://github.com/stdlib-js/nlp-tokenize/tree/deno
